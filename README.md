# 🚶‍♂️ People Counter with SMS Notification and GPS 📡

## 📖 Project Overview
This project implements a **people counting system** using a **TF-Mini LiDAR sensor** and an **Ultrasonic sensor**. It tracks the number of people entering or exiting a space (e.g., a bus 🚌 or room 🏠) and displays the count on an **I2C LCD** 🖥️.  

When the **maximum number of passengers (10)** is reached:  
- ⚠️ Shows a warning message on the LCD: `"MAX PASSENGERS! Drop some to go"`  
...
5. **Test the System** ✅
   - Observe the LCD.  
   - Walk in front of the sensors to increment/decrement the count 🚶‍♀️.  
   - When the count reaches **10**, the LCD will display a warning ⚠️ and an **SMS** will be sent automatically 📲.  
...
- Maximum passenger limit enforcement ⚠️.  
